import { DateTimePickerDemos, HooksDemos, InlineDateTimePickerDemos, NotificationsDemos, RollingNumberDemos, SankeyChartDemos, TreeSelectDemos } from '@docs/demos';
...
<Demo data={HooksDemos.useDragSwipe} />
